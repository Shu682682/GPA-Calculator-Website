...
// parameter2 is the duration
// parameter3 is the original state of the controlled object
// parameter4 is the state of the controlled object after the animation ends
// parameter5
time_line
...
// Let whole website cannot using Enter key
...
// Prevent forms from submitting when pressing the Enter key inside them
...
// After selecting an option in a dropdown, the corresponding color should change
...
// When the credit value is updated, the GPA should also refresh accordingly
...
function changeColor(target) {
  if (target.value == "A" || target.value == "A-") {
    target.style.backgroundColor = "lavenderblush";
    ...
    target.style.backgroundColor = "mediumaquamarine";
    target.style.color = "black";
